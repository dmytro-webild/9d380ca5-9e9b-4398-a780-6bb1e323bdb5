...
export const metadata: Metadata = {
  title: "Zubní ordinace Terident | Brno Židenice",  description: "Moderní stomatologická ordinace v Brně Židenici. Specialisté s individuálním přístupem, mikroskopické ošetření, bezbolestná hygiena. Objednejte se online nebo zavolejte +420 724 142 444.",  keywords: "zubní lékař Brno, stomatolog Židenice, zubní ordinace, bezbolestná hygiena, endodontika, dentální služby",  metadataBase: new URL("https://www.terident.cz"),
  alternates: {
    canonical: "https://www.terident.cz"
  },
  openGraph: {
    title: "Zubní ordinace Terident – Brno Židenice",    description: "Moderní stomatologická péče s individuálním přístupem. Mikroskopické ošetření, bezbolestná hygiena, 3D sken. Objednejte se online.",    url: "https://www.terident.cz",    siteName: "Terident",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/beautiful-spacious-office-dentist_8353-9976.jpg",        alt: "Terident ordinace"
      }
    ],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "Zubní ordinace Terident",    description: "Moderní stomatologická ordinace v Brně Židenici. Zavolejte +420 724 142 444 nebo se objednejte online.",    images: ["http://img.b2bpic.net/free-photo/beautiful-spacious-office-dentist_8353-9976.jpg"]
  },
  robots: {
    index: true,
    follow: true
